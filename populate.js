...
const sections = [
    {
        ...
        name: 'Cardiologie',
        sectionDescription: 'Cardiologia este o specialitate medicală care are ca subiect de studiu bolile inimii și ale vaselor de sânge. Cardiologia cuprinde diagnosticul și tratamentul bolilor cardiace congenitale, bolii cardiace ischemice, insuficienței cardiace, valvulopatiilor, aritmiilor și al bolilor pericardului.',
        doctors: [
            {
                ...
                patients: [
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '23.04.2018', default: Date.now }, 
                                ...
                                results:[
                                        ...
                                        {result: 'Unda Q: amplitudine maxima frac. 14; din unda R, durata 0.06 sec'},
                    ...
                    },
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '05.05.2018', default: Date.now }, 
...

    {
        ...
        sectionDescription: 'Dermato-venerologia reprezintă o specialitate medicală ce se ocupă de totalitatea patofenomenelor care se produc la nivelul organului cutanat (piele, mucoase accesibile, fanere), la orice vârstă, inclusiv boli cu transmitere sexuală (venerice).',
        doctors: [
            {
                ...
                patients: [
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '03.04.2018', default: Date.now }, 
                                analysisTitle: 'Consultatie',
                                results: [
                                        {result: 'Hipersecretie de sebum'},
                                        {result: 'Blocarea glandelor sebacee prin acumularea de celule moarte si sebum cu formarea microcomedoanelor'},
                                ...
                                disease: 'Acnee',
                                medication: 'Tratamnetul local cu retinoizi, antibiotice , peroxid de benzoil'
                            }
                        ]
                    },
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '12.04.2018', default: Date.now }, 
                                analysisTitle: 'Consultatie',
                                results: [
                                        {result: 'Scuame aderente, cu aspect grasos'},
                                        {result: 'Roseata'},
                                        {result: 'Leziuni localizate pe scalp, pe linia de insertie frontala a parului'},
                                        {result: 'Pe torace: leziuni presternale si interscapulare'},
                                ],
                                disease: 'Dermatita seboreică',
                                medication: 'Creme pe baza de cortizon, cu potenta redusa si la nivelul scalpului se va folosi un sampon pe baza de sulf, ketoconazol, seleniu, acid salicilic, zinc.'
                            }
                        ]
                    }
                ]
        ...
        MedicalServicesOffered: [
            ...
            {
                ServiceType: 'Chiuretare veruci vulgare maini sau piciore/ lez.(variabil functie de durata sedintei si nr.lez.)',
                price: 110,
            },
            {
                ServiceType: 'Consultatie',
            ...
            {
                ServiceType: 'E - matrix - rejuvenare faciala / cicatrici post acnee / tratare vergeturi - 1 impuls',
                price: 11,
            },
            {
                ServiceType: 'Electr. Angioame (variabil functie de durata sedintei si nr leziunilor)',
                price: 275,
            },
            {
            ...
            {
                ServiceType: 'Extractie comedoame/ cm (variabil functie de durata sedintei)',
                price: 165,
            },
            {
...

    {
        ...
        doctors: [
            {
                ...
                patients: [
                    ...
                    },
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '22.04.2018', default: Date.now }, 
                                analysisTitle: 'Consultatie',
                                results: [
                                        ...
                                        {result: 'Miros neplacut'},
                                        {result: 'Este necesara inca o vizita la medic pentru prelevarea de secretii vaginale'}
                                ],
                ...
                patients: [
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '05.04.2018', default: Date.now }, 
                                analysisTitle: 'Consultatie + Test Papanicolau',
                                results: [
                                        {result: 'Este prezenta o usoara inflamatie la nivelul colului uterin'},
                                        {result: 'Miros neplacut'},
                                        {result: 'Senzatie de disconfort (usturime) la urinare'}
                                ],
                                disease: 'Candidoza vulvo-vaginala',
        ...
        MedicalServicesOffered: [
            ...
            {
                ServiceType: 'Aspirat endometrial cu sonda tip Pipell (necesita si ex. histopatologic)',
                price: 155,
            },
            {
    ...
    
    {
        ...
        name: 'Oftalmologie',
        sectionDescription: 'Oftalmologia este o ramură a medicinei care se ocupă cu tratarea bolilor organului vederii, ceea ce include ochiul și structurile din jurul ochiului, cum ar fi pleoapele și sistemul lacrimar. Patologia căilor vizuale (nervul optic, căile vizuale centrale) și a cortexului vizual reprezintă un domeniu de graniță între neurologie și oftalmologie ("neurooftalmologie").',
        doctors: [
            {
                ...
                patients: [
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '03.05.2018', default: Date.now }, 
                    ...
                    },
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '12.05.2018', default: Date.now }, 
                        ...
                        doctorVisits: [ 
                            {
                                ...
                                results: [
                                            ...
                                            {result: 'OD ung. deschis pe 360 grt, usor pigmentat, aspect iris in platou'}
                                    ],
                ...
                patients: [
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '22.04.2018', default: Date.now }, 
                                analysisTitle: 'Consultatie B: Consultatie A + FO, TN, test Schirmer',
                                results: [
                                    {result: 'Senzatie de durere, arsura'},
                                    {result: 'Camp vizual bun'}
                                ],
                                disease: 'Sindromul de ochi uscat',
                                medication: 'Prescriptie de ochelari: Lentile cu filtru pentru calculator, ideal, filtru verde'
                            }
                        ]
                    },
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '08.05.2018', default: Date.now }, 
        ...
        MedicalServicesOffered: [
            ...
            {
                ServiceType: 'Consultatie A: acuitate vizuala, autorefractometrie, prescriptie ochelari',
                price: 165,
            },
            {
        ...
        doctors: [
            {
                ...
                patients: [
                        ...
                        doctorVisits: [ 
                            {
                                ...
                                results: [
                                        {result: 'Leziunile eczematoase ale pielii în afectarea mamară sunt asociate eritem, ulceraţie, sângerare'},
                    ...
                    },
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '17.04.2018', default: Date.now }, 
                                analysisTitle: 'Consultatie de specialitate (include si biopsia hepatică)',
                                results: [
                                    {result: 'Dureri abdominale superioare'},
                                    {result: 'Icter'},
                                    {result: 'Rezultate de la teste imagistice, radiografie toracică şi scanare osoasă'}
                                ],
...

    {
        ...
        sectionDescription: 'Imagistica medicală este o specialitate științifică recentă, care reunește o largă varietate de științe în scopul studierii modului în care se formează, înregistrează, transmit, analizează, procesează, percep și se stochează imagini ale organelor sau țesuturilor, prin diferite tehnici, cu scopul de a le folosi pentru a diagnostica bolile.',
        doctors: [
            {
                ...
                patients: [
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '20.04.2018', default: Date.now }, 
                                analysisTitle: 'Radiografie de membre - Picior drept',
                                results: [
                                    {result: 'Piese scheletice cu raporturi normale si cu semnal IRM in limite normale '},
                                    {result: 'Fara traiecte de fractura la nivelul segmentelor osoase examinate'},
                                    {result: 'Interlinii articulare surprinse cu o grosime si semnal in limite normale '},
                                    {result: 'Hipersemnal T2 cu aspect inflamator la nivelul tesutului adipos plantar si la nivelul filetelor musculare ai flexorilor degetelor si muschilor lumbricali ai degetelor II, III si IV '}
                                ],
                    ...
                    },
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '26.04.2018', default: Date.now }, 
                                ...
                                results: [                                        
                                    ...
                                    {result: 'Fara modificari de semnal in structura conului terminal medular'}
                                ],
                ...
                patients: [
                    {
                        ...
                        doctorVisits: [ 
                            {
                                dateOfTheVisit: { type: '10.05.2018', default: Date.now }, 
                                analysisTitle: 'Examen radiologic coloana vertebrala / segment',
                                results: [
        ...
        MedicalServicesOffered: [
            ...
            {
                ServiceType: 'Ex. radiologic torace osos (sau parti) in mai multe planuri/Ex. radiologic torace si organe toracice',
                price: 60,
            },
            {
            ...
            {
                ServiceType: 'Radiografie de membre - Antebrat/Brat/Calcaneu/Coapse/Cot/Gamba/Glezna/Mana/Picior/Pumn/Sold',
                price: 45,
            }
        ]
    },
